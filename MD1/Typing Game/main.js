...
let score = document.getAnimations('score');
let points = 0;
let spans;
let typed;
let seconds = 60;
...
function countdown() {
    ...
    let timer = setInterval(function() {
        ...
        if(seconds == 0) {
            alert ("Game kết thúc. Điểm số của bạn là " + points);
            score.innerHTML = "0";
            words.innerHTML = "";
...
function random() {
    words.innerHTML = "";
    let random = Math.floor(Math.random() * (1943+1));
